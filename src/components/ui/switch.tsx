...
>(({ className, ...props }, ref) => (
  <SwitchPrimitives.Root
    ...
    ref={ref}
  >
    <SwitchPrimitives.Thumb className="pointer-events-none block size-[18px] rounded-full bg-background shadow-lg ring-0 transition-transform data-[state=checked]:translate-x-4 data-[state=unchecked]:translate-x-0" />
  </SwitchPrimitives.Root>
));
